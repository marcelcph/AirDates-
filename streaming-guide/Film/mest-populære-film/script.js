//Kalder på API'en TMDB 

const API_KEY = 'api_key=c6c0bb145b8f4b472b1d0358168f5f7c&with_watch_providers=8|337|119|443|70|77|383|118|350|&watch_region=DK';
...
function showMovies(data) {
    ...
    data.forEach(movie => {
        const {title, poster_path, logo_path, provider_id, provider_name, vote_average, overview, id} = movie;
