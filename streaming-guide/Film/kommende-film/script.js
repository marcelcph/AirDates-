...
const API_KEY = 'api_key=c6c0bb145b8f4b472b1d0358168f5f7c&watch_region=DK';
...
function showMovies(data) {
    ...
    data.forEach(movie => {
        const {title, poster_path, release_date, provider_id, provider_name, vote_average, overview, id, original_title, original_language} = movie;
        const movieEl = document.createElement('div'); 
         //fremtids fix af logo providers 
        //Provider URL -> goes throug all of the ids 
        //getProvider(`https://api.themoviedb.org/3/movie/${id}/watch/providers?api_key=fde5ddeba3b7dec3fc1f51852ca0fb95`);
        ...
        movieEl.innerHTML = `
            ...
            <div class="movie-info">
                ...
                <span class="${getColor(vote_average)} score">${vote_average}</span>
            ...
            <h3 class="movietitle">${original_title}</h3>

            <p class="movietitle">Udgivelsedato: ${release_date}</p>
                ${overview}
                <br/> 
                <button class="know-more" id="${id}">Se trailer</button
            </div>
